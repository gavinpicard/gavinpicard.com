...
function CreatePost() {
  ...
  return (
    <div className="navbar-container">
      <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 253 288.98" fill="white" width="3rem">
      ...
      <ul className="navbar">
        ...
        <Link to="/glog" className="nav-button">GLOG</Link>
